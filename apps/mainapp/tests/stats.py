...
from apps.mainapp.management.commands.stats import CountReportsWithStatusOnDay,NumReports,CityStatRows,CategoryGroupStatRows,CategoryStatRows,StatColGroup,AvgTimeToFix, PercentUnfixed, PercentFixedInDays
