...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VerifiedAuthor.name'
        db.add_column('mainapp_verifiedauthor', 'name', self.gf('django.db.models.fields.CharField')(default=1, max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VerifiedAuthor.name'
        db.delete_column('mainapp_verifiedauthor', 'name')
