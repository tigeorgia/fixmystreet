...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReportUpdate.photo'
        db.alter_column(u'report_updates', 'photo', self.gf('stdimage.fields.StdImageField')(max_length=100))

        # Changing field 'Report.photo'
        db.alter_column(u'reports', 'photo', self.gf('stdimage.fields.StdImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ReportUpdate.photo'
        db.alter_column(u'report_updates', 'photo', self.gf('stdimage.fields.StdImageField')(size={'width': 200, 'force': None, 'height': 200}, max_length=100, thumbnail_size={'width': 133, 'force': None, 'height': 100}))

        # Changing field 'Report.photo'
        db.alter_column(u'reports', 'photo', self.gf('stdimage.fields.StdImageField')(size={'width': 400, 'force': None, 'height': 400}, max_length=100, thumbnail_size={'width': 133, 'force': None, 'height': 100}))
