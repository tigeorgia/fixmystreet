...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReportUpdate.is_fixed'
        db.delete_column(u'report_updates', 'is_fixed')

        # Deleting field 'Report.is_fixed'
        db.delete_column(u'reports', 'is_fixed')


    def backwards(self, orm):
        # Adding field 'ReportUpdate.is_fixed'
        db.add_column(u'report_updates', 'is_fixed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Report.is_fixed'
        db.add_column(u'reports', 'is_fixed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
