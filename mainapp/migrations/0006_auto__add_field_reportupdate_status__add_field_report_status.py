...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportUpdate.status'
        db.add_column(u'report_updates', 'status',
                      self.gf('django.db.models.fields.CharField')(default='not-fixed', max_length=32),
                      keep_default=False)

        # Adding field 'Report.status'
        db.add_column(u'reports', 'status',
                      self.gf('django.db.models.fields.CharField')(default='not-fixed', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportUpdate.status'
        db.delete_column(u'report_updates', 'status')

        # Deleting field 'Report.status'
        db.delete_column(u'reports', 'status')
    ...
    models = {
        ...
        u'mainapp.report': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'not-fixed'", 'max_length': '32'}),
