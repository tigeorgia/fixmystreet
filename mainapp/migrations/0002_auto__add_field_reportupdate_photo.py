...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'report_updates', 'photo', self.gf('contrib.stdimage.fields.StdImageField')(blank=True, default='', max_length=100, thumbnail_size={'width': 133, 'force': None, 'height': 100}, size={'width': 200, 'force': None, 'height': 200}), keep_default=False)
