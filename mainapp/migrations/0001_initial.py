...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reports', (
            ...
            ('photo', self.gf('stdimage.fields.StdImageField')(blank=True, max_length=100, thumbnail_size={'width': 133, 'force': None, 'height': 100}, size={'width': 400, 'force': None, 'height': 400})),
